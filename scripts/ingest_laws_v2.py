...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--output-dir", type=Path, default=PROJECT_ROOT / "data" / "processed" / "laws_v0_2")
    parser.add_argument("--report-dir", type=Path, default=PROJECT_ROOT / "data" / "manifests" / "laws_v0_2")
    parser.add_argument("--model-path", type=Path, default=PROJECT_ROOT / "models" / "bge-m3")
    parser.add_argument("--collection", default=os.getenv("LAWS_COLLECTION", "laws_collection_v0_2"))
